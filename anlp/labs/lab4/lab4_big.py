...
data = np.load("complaints_text.npy", allow_pickle=True)
...
# feature_names_stop = vectorizer_stop.get_feature_names_out()
...
# train_x_features_vt = vt.fit_transform(train_x_features_stop)
# test_x_features_vt = vt.transform(test_x_features_stop)
...
feature_names = vectorizer.get_feature_names_out()
print ("Initial method extracted a total of", len(feature_names), "features")
nb_vt_model, nb_vt_predict = nb_fit_and_predict(train_x_features, train_y,
                                               test_x_features, test_y,
                                               average='weighted')
lr_vt_model, lr_vt_predict = lr_fit_and_predict(train_x_features, train_y,
                                               test_x_features, test_y,
                                               average='weighted')

most_probable_features(nb_vt_model, feature_names, categories, 10)
most_influential_features(lr_vt_model, feature_names, categories, 10)
...
10  bruggeman       B-person_name   O                    N    under          bruggeman      NN      pobj    
...
11  night           I-time          I-date_period        N    at             night          NN      pobj    
...
5   weekend         I-date_period   B-date_period        N    away           weekend        NN      npadvmod
...
18  hours           I-time_period   I-time_period     Y       TIME     for            hour           NNS     pobj    
19  .               O               O                 Y                want           .              .       punct   
...
10  say             O               O                 Y                rebook         say            UH      intj    
11  ,               O               O                 Y                rebook         ,              ,       punct   
12  Wednesday       B-date_from     B-date_to            N    DATE     26th           Wednesday      NNP     compound
13  26th            I-date_from     B-date_to            N    DATE     rebook         26th           NN      npadvmod
...
1   have            O               O                 Y                make           have           VBP     ccomp   
2   just            O               O                 Y                one            just           RB      advmod  
3   one             O               O                 Y       CARDINAL dog            one            CD      nummod  
4   dog             O               O                 Y                have           dog            NN      dobj    
5   I               O               O                 Y                wanted         I              PRP     nsubj   
6   wanted          O               O                 Y                dog            want           VBD     relcl   
7   to              O               O                 Y                have           to             TO      aux     
...
3   coming          O               O                 Y                coming         come           VBG     ROOT    
4   with            O               O                 Y                coming         with           IN      prep    
5   1               B-number        B-date_period        N    CARDINAL cars           1              CD      nummod  
6   cars            O               O                 Y                with           car            NNS     pobj    
7   and             O               O                 Y                coming         and            CC      cc      
8   will            O               O                 Y                need           will           MD      aux     
9   probably        O               O                 Y                need           probably       RB      advmod  
...
4   in              I-time          O                    N             cancel         in             IN      prep    
5   the             I-time          O                    N             booking        the            DT      det     
6   morning         I-time          I-time            Y       TIME     booking        morning        NN      compound
7   restaurant      O               O                 Y                booking        restaurant     NN      compound
8   booking         O               O                 Y                in             booking        NN      pobj    
9   under           O               O                 Y                cancel         under          IN      prep    
10  bruggeman       B-person_name   O                    N             under          bruggeman      NN      pobj    
...
8   of              O               O                 Y                behalf         of             IN      prep    
9   shaida          B-person_name   O                    N             sharon         shaida         NNP     compound
10  sharon          I-person_name   O                    N    PERSON   of             sharon         NNP     pobj    
11  ,               O               O                 Y                book           ,              ,       punct   
12  from            O               O                 Y                book           from           IN      prep    
13  Jan             B-date_from     I-date_from          N    DATE     from           Jan            NNP     pobj    
14  the             I-date_from     O                    N    DATE     12th           the            DT      det     
...
idx word            BIO annotation  BIO prediction  correct?  ent_type head           lemma_         tag_    dep_    
---------------------------------------------------------------------------------  -------------------------------
0   Tuesday         B-date          B-date_from          N    DATE     March          Tuesday        NNP     compound
1   March           I-date          B-date_to            N    DATE     March          March          NNP     ROOT    
2   3               I-date          B-date_period        N    DATE     March          3              CD      nummod  
...
idx word            BIO annotation  BIO prediction  correct?  ent_type head           lemma_         tag_    dep_    
---------------------------------------------------------------------------------  -------------------------------
0   Sunday          B-date          B-date_to            N    DATE     Sunday         Sunday         NNP     ROOT    
...
5   for             O               O                 Y                room           for            IN      prep    
6   8               B-date_period   B-adults             N    DATE     days           8              CD      nummod  
7   days            I-date_period   I-date               N    DATE     for            day            NNS     pobj    
...
5   30th            B-date_to       O                    N    DATE     to             30th           NN      pobj    
6   ,               O               O                 Y                room           ,              ,       punct   
7   a               B-rooms         O                    N             room           a              DT      det     
8   single          I-rooms         I-rooms           Y                room           single         JJ      amod    
9   room            I-rooms         O                    N             room           room           NN      ROOT    
...
12  adults          O               O                 Y                for            adult          NNS     pobj    
13  and             O               O                 Y                adults         and            CC      cc      
14  1               B-kids          B-date_period        N    CARDINAL child          1              CD      nummod  
15  child           O               O                 Y                adults         child          NN      conj    
16  .               O               O                 Y                room           .              .       punct   
...
3   book            O               O                 Y                want           book           VB      xcomp   
4   for             O               O                 Y                book           for            IN      prep    
5   today           B-date_from     B-date               N    DATE     for            today          NN      pobj    
...
---------------------------------------------------------------------------------  -------------------------------
0   for             O               O                 Y                for            for            IN      ROOT    
1   a               B-date_period   O                    N    DATE     week           a              DT      det     
...
3   15th            B-date_from     B-date_to            N    DATE     from           15th           NN      pobj    
4   of              I-date_from     O                    N             15th           of             IN      prep    
5   October         I-date_from     I-date_to            N    DATE     of             October        NNP     pobj    
6   ?               O               O                 Y                nights         ?              .       punct   
...
idx word            BIO annotation  BIO prediction  correct?  ent_type head           lemma_         tag_    dep_    
---------------------------------------------------------------------------------  -------------------------------
0   2               B-date_period   B-adults             N    DATE     weeks          2              CD      nummod  
...
idx word            BIO annotation  BIO prediction  correct?  ent_type head           lemma_         tag_    dep_    
---------------------------------------------------------------------------------  -------------------------------
0   1               B-adults        B-date_period        N    CARDINAL adults         1              CD      nummod  
1   adults          O               O                 Y                adults         adult          NNS     ROOT    
2   and             O               O                 Y                adults         and            CC      cc      
3   8               B-kids          B-adults             N    CARDINAL children       8              CD      nummod  
4   children        O               O                 Y                adults         child          NNS     conj    
5   .               O               O                 Y                adults         .              .       punct   
6   Saturday        B-date_from     B-date_to            N    DATE     Saturday       Saturday       NNP     ROOT    
7   to              O               O                 Y       DATE     Saturday       to             IN      prep    
8   Tuesday         B-date_to       B-date_from          N    DATE     to             Tuesday        NNP     pobj    
...
---------------------------------------------------------------------------------  -------------------------------
0   our             O               O                 Y                kids           our            PRP$    poss    
1   two             B-kids          B-adults             N    CARDINAL kids           two            CD      nummod  
2   kids            O               O                 Y                kids           kid            NNS     ROOT    
3   and             O               O                 Y                kids           and            CC      cc      
4   I               B-adults        O                    N             kids           I              PRP     conj    
...
4   arrive          O               O                 Y                like           arrive         VB      xcomp   
5   on              O               O                 Y                arrive         on             IN      prep    
6   Wednesday       B-date_from     B-date_to            N    DATE     on             Wednesday      NNP     pobj    
...
13  17              I-time_from     B-date_from          N    TIME     afternoon      17             CD      nummod  
...
13  already         O               O                 Y                check          already        RB      advmod  
14  at              O               O                 Y                check          at             IN      prep    
15  12:45           B-time          O                    N    TIME     at             12:45          CD      pobj    
...
10  day             O               I-date_period        N    DATE     leave          day            NN      npadvmod
11  ?               O               O                 Y                need           ?              .       punct   
...
4   for             O               O                 Y                late           for            IN      prep    
5   my              O               O                 Y                reservation    my             PRP$    poss    
6   10              B-time          I-time               N    TIME     4              10             CD      quantmod
7   to              I-time          O                    N    TIME     4              to             TO      quantmod
8   4               I-time          B-people             N    TIME     afternoon      4              CD      nummod  
...
4   with            O               O                 Y                arriving       with           IN      prep    
5   my              O               O                 Y                dogs           my             PRP$    poss    
6   4               B-number        B-people             N    CARDINAL dogs           4              CD      nummod  
7   dogs            O               O                 Y                with           dog            NNS     pobj    
8   .               O               O                 Y                arriving       .              .       punct   
9   Can             O               O                 Y                enter          can            MD      aux     
10  they            O               O                 Y                enter          they           PRP     nsubj   
...
8   Check           O               O                 Y                Check          check          VB      ROOT    
9   in              O               O                 Y                Check          in             IN      prep    
10  6th             B-date_from     I-date_to            N    ORDINAL  in             6th            NN      pobj    
11  of              I-date_from     O                    N             6th            of             IN      prep    
12  Sep             I-date_from     B-date_from          N    ORG      of             Sep            NNP     pobj    
13  and             O               O                 Y                Check          and            CC      cc      
14  check           O               O                 Y                Check          check          VB      conj    
15  out             O               O                 Y                check          out            RP      prt     
16  22nd            B-date_to       B-date_from          N             check          22nd           NN      dobj    
...
1   will            O               O                 Y                be             will           MD      aux     
2   be              O               O                 Y                be             be             VB      ROOT    
3   7               B-number        B-date_period        N    CARDINAL be             7              CD      attr    
...
11  night           I-time          I-date_period        N    TIME     at             night          NN      pobj    
...
idx word            BIO annotation  BIO prediction  correct?  ent_type head           lemma_         tag_    dep_    
---------------------------------------------------------------------------------  -------------------------------
0   6               B-time          B-date_period        N    CARDINAL 15             6              CD      compound
1   15              I-time          B-time               N    CARDINAL have           15             CD      npadvmod
2   I               O               O                 Y                have           I              PRP     nsubj   
3   have            O               O                 Y                have           have           VBP     ROOT    
4   a               O               O                 Y                booking        a              DT      det     
5   table           O               O                 Y                booking        table          NN      compound
...
4   reservation     O               O                 Y                need           reservation    NN      dobj    
5   for             O               O                 Y                reservation    for            IN      prep    
6   5               B-people        B-date_period        N    CARDINAL people         5              CD      nummod  
7   people          O               O                 Y                for            people         NNS     pobj    
8   on              O               O                 Y                reservation    on             IN      prep    
9   March           B-date          B-date_to            N    DATE     13th           March          NNP     compound
10  13th            I-date          B-date_to            N    DATE     on             13th           NN      pobj    
11  at              O               O                 Y                need           at             IN      prep    
12  9               B-time          B-adults             N    TIME     pm             9              CD      nummod  
...
5   room            O               O                 Y                like           room           NN      dobj    
6   for             O               O                 Y                room           for            IN      prep    
7   four            B-people        B-people          Y       CARDINAL for            four           CD      pobj    
8   from            O               O                 Y                room           from           IN      prep    
9   Thursday        B-date_from     B-date_from       Y       DATE     from           Thursday       NNP     pobj    
10  until           O               O                 Y                like           until          IN      prep    
11  Thursday        B-date_to       B-date_from          N    DATE     until          Thursday       NNP     pobj    
...
6   reservation     O               O                 Y                make           reservation    NN      dobj    
7   for             O               O                 Y                reservation    for            IN      prep    
8   5               B-people        B-date_period        N    CARDINAL people         5              CD      nummod  
9   people          O               O                 Y                for            people         NNS     pobj    
10  from            O               O                 Y                make           from           IN      prep    
11  Sunday          B-date_from     B-date_to            N    DATE     from           Sunday         NNP     pobj    
12  10              I-date_from     I-time               N    DATE     Sunday         10             CD      nummod  
13  July            I-date_from     I-date_to            N    DATE     like           July           NNP     npadvmod
...
idx word            BIO annotation  BIO prediction  correct?  ent_type head           lemma_         tag_    dep_    
---------------------------------------------------------------------------------  -------------------------------
0   18th            B-date          B-date_from          N    DATE     18th           18th           NN      ROOT    
1   of              I-date          O                    N    DATE     18th           of             IN      prep    
2   Nov             I-date          I-date_from          N    DATE     of             Nov            NNP     pobj    
...
4   adults          O               O                 Y                bedroom        adult          NNS     appos   
5   and             O               O                 Y                adults         and            CC      cc      
6   one             B-kids          O                    N    CARDINAL child          one            CD      nummod  
7   minor           O               O                 Y                child          minor          JJ      amod    
8   child           O               O                 Y                adults         child          NN      conj    
9   .               O               O                 Y                bedroom        .              .       punct   
...
6   hotel           O               O                 Y                book           hotel          NN      dobj    
7   for             O               O                 Y                book           for            IN      prep    
8   2               B-date_period   B-adults             N    DATE     nights         2              CD      nummod  
9   nights          I-date_period   I-date_period     Y       DATE     for            night          NNS     pobj    
10  for             O               O                 Y                book           for            IN      prep    
11  6               O               B-date_period        N    CARDINAL for            6              CD      pobj    
12  in              O               O                 Y                6              in             IN      prep    
13  three           B-rooms         B-date_period        N    CARDINAL rooms          three          CD      nummod  
14  rooms           O               O                 Y                in             room           NNS     pobj    
15  for             O               O                 Y                book           for            IN      prep    
16  Friday          B-date_from     B-date_from       Y       DATE     for            Friday         NNP     pobj    
17  to              O               O                 Y       DATE     book           to             IN      prep    
...
5   weekend         I-date_period   B-date_period        N    DATE     away           weekend        NN      npadvmod
6   away            O               O                 Y                book           away           RB      advmod  
7   for             O               O                 Y                away           for            IN      prep    
8   myself          B-adults        O                    N             for            myself         PRP     pobj    
9   and             I-adults        O                    N             myself         and            CC      cc      
...
12  for             O               O                 Y                book           for            IN      prep    
13  the             O               O                 Y                May            the            DT      det     
14  29              B-date_from     B-date_from       Y       CARDINAL May            29             CD      nummod  
15  May             I-date_from     I-date_from       Y                please         May            NNP     compound
16  please          O               O                 Y                book           please         UH      intj    
17  .               O               O                 Y                would          .              .       punct   
...
idx word            BIO annotation  BIO prediction  correct?  ent_type head           lemma_         tag_    dep_    
---------------------------------------------------------------------------------  -------------------------------
0   One             B-date_period   B-adults             N    TIME     night          one            CD      nummod  
1   night           I-date_period   I-date_period     Y       TIME     17th           night          NN      npadvmod
2   for             O               O                 Y                night          for            IN      prep    
3   next            O               B-date               N    DATE     Friday         next           JJ      amod    
...
4   29th            I-date_from     B-date_from          N    DATE     from           29th           NN      pobj    
...
7   with            O               O                 Y                coming         with           IN      prep    
8   our             O               O                 Y                sons           our            PRP$    poss    
9   three           B-kids          B-date_period        N    CARDINAL sons           three          CD      nummod  
10  sons            O               O                 Y                with           son            NNS     pobj    
...
idx word            BIO annotation  BIO prediction  correct?  ent_type head           lemma_         tag_    dep_    
---------------------------------------------------------------------------------  -------------------------------
0   7th             B-date_from     B-date_from       Y       DATE     7th            7th            JJ      ROOT    
1   to              O               O                 Y       DATE     7th            to             IN      prep    
2   21st            B-date_to       I-date               N    DATE     to             21st           NN      pobj    
...
0   until           O               O                 Y                until          until          IN      ROOT    
1   the             O               O                 Y                2nd            the            DT      det     
2   2nd             B-date_to       I-date               N    ORDINAL  until          2nd            JJ      pobj    

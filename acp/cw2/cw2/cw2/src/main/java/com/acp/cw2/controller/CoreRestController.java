...
public class CoreRestController {
     ...
     */
    @PostMapping(value="/readTopic/{topicName}", produces = MediaType.TEXT_PLAIN_VALUE)
    public String readTopic(@PathVariable String topicName, @RequestBody List<Map<String, String>> propertiesList) {
        Properties properties;

        try {
            properties = CoreRestController.loadConfig("./configfile");
        } catch (Exception e) {
            throw new BadRequestException("Error loading config file");
        }
     ...
     */
    @PostMapping(value="/writeTopic/{topicName}/{data}", produces = MediaType.TEXT_PLAIN_VALUE, consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.TEXT_PLAIN_VALUE})

...
public class SortOperator extends Operator{
    ...
    public SortOperator(Operator operator, List<OrderByElement> orderByElement) {
        ...
        if(this.allTuples.isEmpty()) return;
        ...
        /*
        List.sort() might be marginally faster due to it being a direct call on the list object without the extra step of the Collections.sort() method call.
         */
        this.allTuples.sort(new TupleComparator()); //sort the tuples according to the TupleComparator
    }

    /**
     * SortOperator constructor for sorting after sum aggregation where all tuples are available
     ...
     */
    public List<Tuple> getSortedTuples(){ return this.allTuples;}
    /**
     * Not used
     */
    @Override
